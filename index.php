...
<html class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="theme-assets/css/bootstrap4-neon-glow.css">
    <link rel="stylesheet" type="text/css" href="theme-assets/css/app-lite.css">
    <link rel="stylesheet" type="text/css" href="theme-assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="theme-assets/css/core/colors/palette-gradient.css">
    	 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
  </head>
  <body class="card mb-2 text-white"> 
  <div class="card mb-2 text-white">
    ...
    <div class="app-content content">
      <div class="content-wrapper">
        <div class="content-wrapper-before mb-8">        	
        </div>        
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h1 class="text-white"><strong>𝐒𝐓𝐑𝐈𝐏𝐄 𝐊𝐄𝐘 𝐂𝐇𝐄𝐂𝐊𝐄𝐑</strong></h1>
          <h1 class="text-white"><span class="vim-caret">⠀𝗣𝗮𝗿𝘃𝗲𝘇⠀</span></h1>
					<textarea rows="8" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR SK HERE:>"></textarea>												
...
<div class="col-md-4">
  <div class="navbar-dark text-white">
  	<div class="card-body">
<h5 class="text-white">LIVE :<span class="badge badge-success float-right charge text">0</span></h5><hr>

<h5 class="text-white">RATE LIMIT :<span class="badge badge-success float-right aprovadas">0</span></h5><hr>

<h5 class="text-white">DIE :<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>

<h5 class="text-white">TOTAL :<span class="badge badge-primary float-right carregadas">0</span></h5><hr>

<h5 class="text-white">LIMIT :<span class="badge badge-secondary float-right">5000000</span></h5>
			...
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1 text-white"><i class="fa fa-check-circle text-success"></i> LIVE</h4>					
			<div class="navbar-dark card-body" id='lista_charge'></div>
				</div>				
			</div>
		</div>
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1 text-white"><i class="fa fa-check text-success"></i> RATE LIMIT</h4>					
			<div  class="navbar-dark card-body" id='lista_aprovadas'></div>
				</div>				
			</div>
		</div>
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1 text-white"><i class="fa fa-times text-danger"></i> DECLINED</h4>		
						<div style='display: none;'  class="navbar-dark card-body" id='lista_reprovadas'></div>
				</div>				
			</div>
		</div>
...
var callBack = $.ajax({
	...
	success: function(retorno){
		if(retorno.indexOf("#LIVE") >= 0){
			...
			else if(retorno.indexOf("#Rate_limit") >= 0){
			Swal.fire({title: '+1 LIVE SK', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
