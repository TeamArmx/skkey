...
if(isset($_POST['login'])){
  ...
  $password = $_POST['password'];
   if($password === '@ModByParvez'){
     $_SESSION['login'] = true; header('LOCATION:../index.php'); die();
   } {
     echo "<div class='alert alert-danger'>GO TO HEAVEN BRO CHILL</div>";
   }
    ...
    <div class="authentication-lock-screen d-flex align-items-center justify-content-center">
      <div class="card shadow-none bg-transparent">
        <div class="card-body p-md-5 text-center">
          <h1 class="text-white"><a style="color:white">PARVEZ ON FIRE</a></h1>
          <div class="">
          </div>
          </br>
          <p class="mt-2 text-white">PASS : @ModByParvez</p><br>
